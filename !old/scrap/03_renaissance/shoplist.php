...
//取得元URL指定
$html = file_get_html('http://www.s-re.jp/club/#area0');

//取得条件指定して配列に格納
//$tag = $html->find('//*[@id="contents_inner"]/div[2]/ul/li/h4/a');
$shop_name = $html->find('//*[@id="clubList"]/div/div/div/table/tbody/tr/th/a');
$address = $html->find('//*[@id="clubList"]/div[1]/div/div/table/tbody/tr/td/p/text()[1]');

print_r($shop_name);

for ($j = 1, $end = count($shop_name); $j < $end ; ++$j) {
