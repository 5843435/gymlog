...
$sql ="
SELECT shop.shopname, shop.address, program.program, program.week, program.time, program.tantou
FROM shop JOIN program ON shop.shop_id = program.shop_id
WHERE (shop.shopname LIKE '%$place%' or shop.address LIKE '%$place%') AND program.week LIKE '%$week%'
